        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Built specifically for people with ADHD, 4Focus provides the tools
              and structure you need to manage tasks effectively.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {eisenhowerMatrix.map((quadrant, index) => (
              <Card key={index} className="relative overflow-hidden">
                ...
                />
                <CardHeader>
                  <CardTitle className="text-lg">{quadrant.quadrant}</CardTitle>
